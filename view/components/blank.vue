<template>
    <section>
        ...
        <div v-if="$route.name=='abi'">
            <el-button class="copy-button" :data-clipboard-text="JSON.stringify(abi)">Copy</el-button>
            <vue-json-pretty
                :show-length="true"
                :data="abi">
            </vue-json-pretty>
        ...
        <div v-if="$route.name=='asm'">
            <el-button class="copy-button" :data-clipboard-text="asm">Copy</el-button>
            <code>{{asm}}</code>
        </div>
        <div v-if="$route.name=='binary'">
            <el-button class="copy-button" :data-clipboard-text="bytecodes">Copy</el-button>
            <code>{{bytecodes}}</code>
        </div>
        <div v-if="$route.name=='offchain'">
            <el-button class="copy-button" :data-clipboard-text="offchain" >Copy</el-button>
            <code>{{offchain}}</code>
        </div>
    </section>
</template>
